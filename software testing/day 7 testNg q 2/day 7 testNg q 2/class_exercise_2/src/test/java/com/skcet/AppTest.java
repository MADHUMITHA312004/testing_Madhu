...
public class AppTest {
    ...
    public void testingEconomicTimes() throws Exception {
        ...
        driver.findElement(
                By.xpath("/html/body/div[3]/header/div[1]/div[1]/div/div/div[2]/div/div/form/div[2]/div[2]/ul/li[1]")).click();

        js.executeScript("window.scrollBy(0,500)");
        WebElement reliance = driver.findElement(By.xpath("//*[@id=\"stockName\"]/h1"));
